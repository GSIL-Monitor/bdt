    ...
    <div slot="title">
      <div>
        <Row :gutter="0" type="flex" align="middle">
          <i-col span="5"><span style="font-size: 16px;font-weight: bold">投注子系统TZ1-4</span>
          </i-col>
...
<script>
  const startTZXT = 14;
  const getTzSystemInfo_tzListData = 'getTzSystemInfo14_tzListData';
  const getTzSystemInfo_tzSystem = 'getTzSystemInfo14_tzSystem';
  export default {
    name: "tzSystemInfo",
    data() {
      return {
