    ...
    <div slot="title">
      <div>
        <Row :gutter="0" type="flex" align="middle">
          <i-col span="5"><span style="font-size: 16px;font-weight: bold">投注子系统TZ1-2</span>
          </i-col>
...
<script>
  const startTZXT = 12;
  const getTzSystemInfo_tzListData = 'getTzSystemInfo12_tzListData';
  const getTzSystemInfo_tzSystem = 'getTzSystemInfo12_tzSystem';
  export default {
    name: "tzSystemInfo",
    data() {
      return {
