...
public class CalcXGLZGLServiceNotMap {
    ...
    private BigDecimal pshx;


    public static void main(String[] args) {
        CalcXGLZGLServiceNotMap service = new CalcXGLZGLServiceNotMap();
        synchronized (service) {
            service.calcXgl(1, 8, "5307--", new BigDecimal(0.001));
            service.calcXgl(2, 8, "5090--", new BigDecimal(0.001));
            service.calcXgl(3, 8, "009640", new BigDecimal(0.001));
            service.calcXgl(4, 8, "204693", new BigDecimal(0.001));
            service.calcXgl(5, 8, "50052", new BigDecimal(0.001));
        }
...
//        System.out.println(12345 % 10000 / 1000);
     ...
     * @param inputNum 牌面数据
     */
    public Map<String, BigDecimal> calcXgl(int fitNo, int ps, String inputNum, BigDecimal pshx) {
        this.pshx = pshx;
        synchronized (this) {
            return startCalcSystem(fitNo, ps, inputNum);
        }
    }

    private Map<String, BigDecimal> startCalcSystem(int fitNo, int ps, String inputNum) {
        //副号=1
        if (fitNo == 1) {
            n0 = ps * 16;
            n1 = ps * 4;
        ...
        return step1(inputNum);
    }

    private Map<String, BigDecimal> step1(String inputNum) {
        j4 = BigDecimal.ZERO;
        j5 = BigDecimal.ZERO;
        j6 = BigDecimal.ZERO;
        p4 = BigDecimal.ZERO;
        ...
        w5 = BigDecimal.ZERO;
        w6 = BigDecimal.ZERO;
        return step2(inputNum);
    }

    private Map<String, BigDecimal> step2(String inputNum) {
    ...
    private Map<String, BigDecimal> step3() {
        n0 = n0 - k0;
        n1 = n1 - k1;
        n2 = n2 - k2;
        n3 = n3 - k3;
    ...
    private Map<String, BigDecimal> step4() {
        s = n0 + n1 + n2 + n3 + n4 + n5 +
                n6 + n7 + n8 + n9;
        return step5_1();
    }

    private Map<String, BigDecimal> step5_1() {
        g = 10000;
        ma = BigDecimal.ZERO;
        mb = BigDecimal.ZERO;
        mc = BigDecimal.ZERO;
    ...
    private Map<String, BigDecimal> step5_2() {
        //步骤5-2
        X[0] = n0;
        X[1] = n1;
        X[2] = n2;
    ...
    private Map<String, BigDecimal> step5_3() {
        //步骤5-3-1
        //5-3-2
    ...
    private Map<String, BigDecimal> step5_4_1() {
        //步骤5-4
        //5-4-1
    ...
    private Map<String, BigDecimal> step5_4_2() {
        //5-4-2
    ...
    private Map<String, BigDecimal> step_5_4_3() {
        //5-4-3
    ...
    private Map<String, BigDecimal> step5_4_4() {
        //5-4-4
    ...
    private Map<String, BigDecimal> step5_4_5_1() {
        //5-4-5-1
        e = 0;
        return step5_4_5_2();
    }
    ...
    private Map<String, BigDecimal> step5_4_5_2() {
        //5-4-5-2
        me = new BigDecimal(X[e]);
        return step5_4_5_3();
    }

    private Map<String, BigDecimal> step5_4_5_3() {
        //5-4-5-3
        f = 0;
        return step5_4_5_4();
    }

    private Map<String, BigDecimal> step5_4_5_4() {
        //5-4-5-4
        if (f == e) {
    ...
    private Map<String, BigDecimal> step5_4_5_5() {
        //5-4-5-5
    ...
    private Map<String, BigDecimal> step5_4_5_6() {
        //5-4-5-6
    ...
    private Map<String, BigDecimal> step5_4_5_7() {
        //5-4-5-7
        if (f < 9) {
            return step5_4_5_8();
        } else if (f == 9) {
    ...
    private Map<String, BigDecimal> step5_4_5_8() {
        //5-4-5-8
        f = f + 1;
        return step5_4_5_4();
    }

    private Map<String, BigDecimal> step5_4_5_9() {
        //5-4-5-9
        if (e < 9) {
            return step5_4_5_10();
        } else if (e == 9) {
    ...
    private Map<String, BigDecimal> step5_4_5_10() {
        //5-4-5-10
        e = e + 1;
        //5-4-5-2
        return step5_4_5_2();
    ...
    private Map<String, BigDecimal> step_5_4_6_1() {
        //5-4-6-1
        e = 0;
        //5-4-6-2
        return step5_4_6_2();
    ...
    private Map<String, BigDecimal> step5_4_6_2() {
        //5-4-6-2
        me = new BigDecimal(X[e]);
        return step5_4_6_3();
    }

    private Map<String, BigDecimal> step5_4_6_3() {
        //5-4-6-3
        if (e == 8) {
            return step5_4_6_4();
    ...
    private Map<String, BigDecimal> step5_4_6_4() {
        //5-4-6-4
    ...
    private Map<String, BigDecimal> step5_4_6_5() {
        //5-4-6-5
...
//        }
    ...
    private Map<String, BigDecimal> step5_4_6_6() {
        //5-4-6-6
        f = 0;
        return step5_4_6_7();
    }

    private Map<String, BigDecimal> step5_4_6_7() {
        //5-4-6-7
        if (f == e) {
            mf = new BigDecimal(X[e] - 1);
        } else {
    ...
    private Map<String, BigDecimal> step5_4_6_8() {
        //5-4-6-8
        if (ma.intValue() > 0 && mb.intValue() > 0 && mc.intValue() > 0 && md.intValue() > 0 && me.intValue() > 0 && mf.intValue() > 0) {
            j6 = ma.multiply(mb).multiply(mc).multiply(md).multiply(me).multiply(mf);
        } else if (ma.intValue() <= 0 || mb.intValue() <= 0 || mc.intValue() <= 0 || md.intValue() <= 0 || me.intValue() <= 0 || mf.intValue() <= 0) {
    ...
    private Map<String, BigDecimal> step5_4_6_9() {
        //5-4-6-9
        if (right(a + c + e) > right(b + d + f)) {
            p6 = p6.add(j6);
        }
    ...
    private Map<String, BigDecimal> step5_4_6_10() {
        //5-4-6-10
        if (f < 9) {
            return step5_4_6_11();
        } else if (f == 9) {
    ...
    private Map<String, BigDecimal> step5_4_6_11() {
        //5-4-6-11
        f = f + 1;
        return step5_4_6_7();
    }

    private Map<String, BigDecimal> step5_4_6_12() {
        //5-4-6-12
        if (e < 9) {
            return step5_4_6_13();
        } else if (e == 9) {
    ...
    private Map<String, BigDecimal> step5_4_6_13() {
        //5-4-6-13
        e = e + 1;
        //5-4-6-2
        return step5_4_6_2();
    ...
    private Map<String, BigDecimal> step5_4_7_1() {
        e = 0;
        //5-4-7-2
        return step5_4_7_2();
    }

    private Map<String, BigDecimal> step5_4_7_2() {
        me = new BigDecimal(X[e]);
        //5-4-7-3
        return step5_4_7_3();
    }

    private Map<String, BigDecimal> step5_4_7_3() {
        if (e == 0 || e == 1 || e == 8 || e == 9) {
            //5-4-7-4
            return step5_4_7_4();
    ...
    private Map<String, BigDecimal> step5_4_7_4() {
        if (ma.intValue() > 0 && mb.intValue() > 0 && mc.intValue() > 0 && md.intValue() > 0 && me.intValue() > 0) {
            j5 = ma.multiply(mb).multiply(mc).multiply(md).multiply(me);
        } else if (ma.intValue() <= 0 || mb.intValue() <= 0 || mc.intValue() <= 0 || md.intValue() <= 0 || me.intValue() <= 0) {
            j5 = BigDecimal.ZERO;
    ...
    private Map<String, BigDecimal> step5_4_7_5() {
        //5-4-7-5
        if (right(a + c + e) > right(b + d)) {
            p5 = p5.add(j5);
        }
...
//        }
    ...
    private Map<String, BigDecimal> step5_4_7_6() {
        f = 0;
        return step5_4_7_7();
    }

    private Map<String, BigDecimal> step5_4_7_7() {
        //5-4-7-7
        if (f == e) {
            mf = new BigDecimal(X[e] - 1);
        } else {
    ...
    private Map<String, BigDecimal> step5_4_7_8() {
        //5-4-7-8
        if (ma.intValue() > 0 && mb.intValue() > 0 && mc.intValue() > 0 && md.intValue() > 0 && me.intValue() > 0 && mf.intValue() > 0) {
            j6 = ma.multiply(mb).multiply(mc).multiply(md).multiply(me).multiply(mf);
        } else if (ma.intValue() <= 0 || mb.intValue() <= 0 || mc.intValue() <= 0 || md.intValue() <= 0 || me.intValue() <= 0 || mf.intValue() <= 0) {
    ...
    private Map<String, BigDecimal> step5_4_7_9() {
        //5-4-7-9
        if (right(a + c + e) > right(b + d + f)) {
            p6 = p6.add(j6);
        }
    ...
    private Map<String, BigDecimal> step5_4_7_10() {
        //5-4-7-10
        if (f < 9) {
            return step5_4_7_11();
        } else if (f == 9) {
    ...
    private Map<String, BigDecimal> step5_4_7_11() {
        //5-4-7-11
        f = f + 1;
        return step5_4_7_7();
    }
    ...
    private Map<String, BigDecimal> step5_4_7_12() {
        //5-4-7-12
        if (e < 9) {
            //5-4-7-13
            return step5_4_7_13();
    ...
    private Map<String, BigDecimal> step5_4_7_13() {
        e = e + 1;
        //5-4-7-2
        return step5_4_7_2();
    }

    private Map<String, BigDecimal> step5_4_8_1() {
        //5-4-8-1
        e = 0;
        //5-4-8-2
        return step5_4_8_2();
    ...
    private Map<String, BigDecimal> step5_4_8_2() {
        me = new BigDecimal(X[e]);
        return step5_4_8_3();
    }

    private Map<String, BigDecimal> step5_4_8_3() {//not
        //5-4-8-3
    ...
    private Map<String, BigDecimal> step5_4_8_4() {
        //5-4-8-4
        if (ma.intValue() > 0 && mb.intValue() > 0 && mc.intValue() > 0 && md.intValue() > 0 && me.intValue() > 0) {
            j5 = ma.multiply(mb).multiply(mc).multiply(md).multiply(me);
        } else if (ma.intValue() <= 0 || mb.intValue() <= 0 || mc.intValue() <= 0 || md.intValue() <= 0 || me.intValue() <= 0) {
    ...
    private Map<String, BigDecimal> step5_4_8_5() {
        //5-4-8-5
        if (right(a + c + e) > right(b + d)) {
            p5 = p5.add(j5);
        }
...
//        }
    ...
    private Map<String, BigDecimal> step5_4_8_6() {
        //5-4-8-6
        f = 0;
        //5-4-8-7
        return step5_4_8_7();
    ...
    private Map<String, BigDecimal> step5_4_8_7() {
        if (f == e) {
            mf = new BigDecimal(X[e] - 1);
        } else {
            mf = new BigDecimal(X[f]);
    ...
    private Map<String, BigDecimal> step5_4_8_8() {
        //5-4-8-8
        if (ma.intValue() > 0 && mb.intValue() > 0 && mc.intValue() > 0 && md.intValue() > 0 && me.intValue() > 0 && mf.intValue() > 0) {
            j6 = ma.multiply(mb).multiply(mc).multiply(md).multiply(me).multiply(mf);
        } else if (ma.intValue() <= 0 || mb.intValue() <= 0 || mc.intValue() <= 0 || md.intValue() <= 0 || me.intValue() <= 0 || mf.intValue() <= 0) {
    ...
    private Map<String, BigDecimal> step5_4_8_9() {
        //5-4-8-9
        if (right(a + c + e) > right(b + d + f)) {
            p6 = p6.add(j6);
        }
    ...
    private Map<String, BigDecimal> step5_4_8_10() {
        //5-4-8-10
        if (f < 9) {
            return step_5_4_8_11();
        } else if (f == 9) {
            //5-4-8-13
            return step5_4_8_13();
        }
    ...
    private Map<String, BigDecimal> step_5_4_8_11() {
        //5-4-8-11
        f = f + 1;
        return step5_4_8_7();
    }

    private Map<String, BigDecimal> step5_4_8_12() {
        //5-4-8-12
        if (e < 9) {
            //5-4-8-13
            return step5_4_8_13();
    ...
    private Map<String, BigDecimal> step5_4_8_13() {
        e = e + 1;
        return step5_4_8_2();
    }

    private Map<String, BigDecimal> step5_4_9_1() {
        //5-4-9-1
        e = 0;
        return step5_4_9_2();
    }

    private Map<String, BigDecimal> step5_4_9_2() {
        me = new BigDecimal(X[e]);
        return step5_4_9_3();
    }

    private Map<String, BigDecimal> step5_4_9_3() {
        //5-4-9-3
    ...
    private Map<String, BigDecimal> step5_4_9_4() {
        //5-4-9-4
        if (ma.intValue() > 0 && mb.intValue() > 0 && mc.intValue() > 0 && md.intValue() > 0 && me.intValue() > 0) {
            j5 = ma.multiply(mb).multiply(mc).multiply(md).multiply(me);
        } else if (ma.intValue() <= 0 || mb.intValue() <= 0 || mc.intValue() <= 0 || md.intValue() <= 0 || me.intValue() <= 0) {
    ...
    private Map<String, BigDecimal> step5_4_9_5() {
        //5-4-9-5
        if (right(a + c + e) > right(b + d)) {
            p5 = p5.add(j5);
        }
...
//        }
    ...
    private Map<String, BigDecimal> step5_4_9_6() {
        //5-4-9-6
        f = 0;
        return step5_4_9_7();
    }

    private Map<String, BigDecimal> step5_4_9_7() {
        if (f == e) {
            mf = new BigDecimal(X[e] - 1);
        } else {
            mf = new BigDecimal(X[f]);
    ...
    private Map<String, BigDecimal> step5_4_9_8() {
        //5-4-9-8
        if (ma.intValue() > 0 && mb.intValue() > 0 && mc.intValue() > 0 && md.intValue() > 0 && me.intValue() > 0 && mf.intValue() > 0) {
            j6 = ma.multiply(mb).multiply(mc).multiply(md).multiply(me).multiply(mf);
        } else if (ma.intValue() <= 0 || mb.intValue() <= 0 || mc.intValue() <= 0 || md.intValue() <= 0 || me.intValue() <= 0 || mf.intValue() <= 0) {
    ...
    private Map<String, BigDecimal> step5_4_9_9() {
        //5-4-9-9
        if (right(a + c + e) > right(b + d + f)) {
            p6 = p6.add(j6);
        }
    ...
    private Map<String, BigDecimal> step5_4_9_10() {
        //5-4-9-10
        if (f < 9) {
            return step5_4_9_11();
        } else if (f == 9) {
    ...
    private Map<String, BigDecimal> step5_4_9_11() {
        //5-4-9-11
        f = f + 1;
        //5-4-9-7
        return step5_4_9_7();
    ...
    private Map<String, BigDecimal> step5_4_9_12() {
        //5-4-9-12
        if (e < 9) {
            //5-4-9-13
            return step5_4_9_13();
    ...
    private Map<String, BigDecimal> step5_4_9_13() {
        e = e + 1;
        //5-4-9-2
        return step5_4_9_2();
    }

    private Map<String, BigDecimal> step5_4_10_1() {
        //5-4-10-1
    ...
    private Map<String, BigDecimal> step5_4_10_2() {
        //5-4-10-2
        f = 0;
        return step5_4_10_3();
    }

    private Map<String, BigDecimal> step5_4_10_3() {
        //5-4-10-3
        mf = new BigDecimal(X[f]);
        return step5_4_10_4();
    }

    private Map<String, BigDecimal> step5_4_10_4() {
        //5-4-10-4
    ...
    private Map<String, BigDecimal> step5_4_10_5() {
//        if (g == 10060) {
...
//        }
    ...
    private Map<String, BigDecimal> step5_4_10_6() {
        //5-4-10-6
        if (f < 9) {
            return step_5_4_10_7();
        } else if (f == 9) {
            //5-5
            return step5_5();
        }
    ...
    private Map<String, BigDecimal> step_5_4_10_7() {
        //5-4-10-7
        f = f + 1;
        //5-4-10-3
        return step5_4_10_3();
    ...
    private Map<String, BigDecimal> step5_4_11_1() {
        e = 0;
        return step5_4_11_2();
    }

    private Map<String, BigDecimal> step5_4_11_2() {
        me = new BigDecimal(X[e]);
        return step5_4_11_3();
    }

    private Map<String, BigDecimal> step5_4_11_3() {
        if (ma.intValue() > 0 && mb.intValue() > 0 && mc.intValue() > 0 && md.intValue() > 0 && me.intValue() > 0) {
            j5 = ma.multiply(mb).multiply(mc).multiply(md).multiply(me);
        } else {
            j5 = BigDecimal.ZERO;
    ...
    private Map<String, BigDecimal> step5_4_11_4() {
        if (right(a + c + e) > right(b + d)) {
            p5 = p5.add(j5);
...
//        }
    ...
    private Map<String, BigDecimal> step5_4_11_5() {
        if (e < 9) {
            return step5_4_11_6();
        } else if (e == 9) {
            return step5_5();
    ...
    private Map<String, BigDecimal> step5_4_11_6() {
        e = e + 1;
        return step5_4_11_2();
    }

    private Map<String, BigDecimal> step5_5() {
//        if (g == 10060) {
//            System.out.println("a" + a + "b" + b + "c" + c + "d" + d);
//            System.out.println(g);
//            System.out.println("ma" + ma + "mb" + mb + "mc" + mc + "md" + md + "me" + me + "mf" + mf);
...
//        }
    ...
    private Map<String, BigDecimal> step5_6() {
        //5-6
        g = g + 1;
        return step5_2();
    }

    private Map<String, BigDecimal> step6() {
        Map<String, BigDecimal> calcResult = new HashMap<>();
        System.out.println("=====");
//        System.out.println(g);
//        System.out.println("ma" + ma + "mb" + mb + "mc" + mc + "md" + md + "me" + me + "mf" + mf);
//        System.out.println(ma.multiply(mb).multiply(mc).multiply(md).multiply(me).multiply(mf));
...
//        BigDecimal zsy = new BigDecimal(0.95).multiply(zgl).subtract(xgl).add((xgl.add(zgl).multiply(pshx)));
        ...
        calcResult.put("zgl", zgl);
//        calcResult.put("hgl", hgl);
        calcResult.put("xtsl", xtsl);
        calcResult.put("ztsl", ztsl);
        System.out.println(xtsl);
        System.out.println(ztsl);
//        calcResult.put("xsy", xsy);
//        calcResult.put("zsy", zsy);
